...
public class Parser {
	...
	public Configuration loadConfig(String name) {
		try (BufferedReader br = new BufferedReader(new FileReader(name+".json"))) {
			...
			System.out.println("Unable to open file '" + name+".json" + "'");
		} catch (IOException ex) {
			System.out.println("Error reading file '" + name+".json" + "'");
		}
		return null;
	}
	...
	public void saveConfig(Configuration config, String name) {
        ...
        try {
        	...
        	System.out.println("Error creating file '" + name+".json" + "'");
		}
